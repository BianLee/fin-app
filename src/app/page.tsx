...
const Home = () => {
    ...
    const calculateBondShift = () => {
        ...
        return {
            demandShift:
                demandShift > 0
                    ? `Right by ${demandShift}`
                    : `Left by ${Math.abs(demandShift)}`,
            supplyShift:
                supplyShift > 0
                    ? `Right by ${supplyShift}`
                    : `Left by ${Math.abs(supplyShift)}`,
            interestRateEffect:
                demandShift - supplyShift < 0 ? "Increase" : "Decrease",
        };
    };
    ...
    useEffect(() => {
        ...
        const newBondData = initialBondData.map((item) => {
            ...
            const adjustmentFactor =
                inflationEffect + wealthEffect + riskEffect;

            // Adjust price (constrained to reasonable bounds)
            const newPrice = Math.max(
                500,
                Math.min(1100, item.price + adjustmentFactor)
            );
    ...
    const renderBondMarket = () => (
        <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="mb-4">
                Adjust the sliders to see how different factors affect bond
                markets.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <div className="mb-4">
                        <label className="block mb-2">
                            Expected Inflation: {expectedInflation}%
                        </label>
                        <input
                            type="range"
                            min="0"
                            ...
                            onChange={(e) =>
                                setExpectedInflation(Number(e.target.value))
                            }
                            className="w-full"
                        />
                    </div>
                    ...
                    <div className="mb-4">
                        <label className="block mb-2">
                            Wealth Level: {wealthLevel} (Higher = More Wealth)
                        </label>
                        <input
                            type="range"
                            min="1"
                            ...
                            value={wealthLevel}
                            onChange={(e) =>
                                setWealthLevel(Number(e.target.value))
                            }
                            className="w-full"
                        />
                    </div>
                    ...
                    <div className="mb-4">
                        <label className="block mb-2">
                            Risk Level: {riskLevel} (Higher = More Risk)
                        </label>
                        <input
                            type="range"
                            min="1"
                    ...
                    <div className="p-4 bg-gray-100 rounded-lg">
                        ...
                        <p>
                            <strong>Demand Curve Shift:</strong>{" "}
                            {bondResult.demandShift}
                        </p>
                        <p>
                            <strong>Supply Curve Shift:</strong>{" "}
                            {bondResult.supplyShift}
                        </p>
                        <p>
                            <strong>Interest Rate:</strong>{" "}
                            {bondResult.interestRateEffect}
                        </p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                        Note the inverse relationship between bond prices and
                        interest rates.
                    </p>
                </div>
            </div>
    ...
    const renderMoneyInterestRates = () => (
        <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4">
                Money Growth and Interest Rates (1950-2020)
            </h2>
            ...
            <div className="mt-6 p-4 bg-gray-100 rounded-lg">
                <h3 className="font-semibold mb-2">
                    Key Insights from the Liquidity Preference Framework:
                </h3>
                <ul className="list-disc pl-5 space-y-2">
                    <li>
                        When the central bank increases money supply, the
                        initial effect (liquidity effect) is a decrease in
                        interest rates.
                    </li>
                    <li>
                        However, if increased money supply raises income or
                        price levels, interest rates may eventually rise (income
                        and price-level effects).
                    </li>
                    <li>
                        If money growth leads to higher expected inflation,
                        interest rates will rise further (expected-inflation
                        effect).
                    </li>
                    <li>
                        The relationship between money growth and interest rates
    ...
    const renderFinancialSystem = () => (
        <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="mt-6 p-4 bg-gray-100 rounded-lg">
                ...
                <ul className="list-disc pl-5 space-y-2">
                    <li>
                        <strong>Lower Transaction Costs:</strong> Economies of
                        scale and scope
                    </li>
                    <li>
                        <strong>Risk Sharing:</strong> Diversification across
                        many investments
                    </li>
                    <li>
                        <strong>Information Management:</strong> Reducing
                        adverse selection and moral hazard
                    </li>
                    <li>
                        <strong>Liquidity:</strong> Providing access to funds
                        when needed
                    </li>
                </ul>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                        Fisher Equation: r = i - πᵉ (real rate = nominal rate -
                        expected inflation)
                    </p>
                </div>
                ...
                <div>
                    <h3 className="font-semibold mb-3">
                        How Expected Inflation Affects Bond Markets:
                    </h3>
                    <div className="p-4 bg-gray-100 rounded-lg">
                        ...
                        <ul className="list-disc pl-5 space-y-1">
                            <li>
                                Bond demand curve shifts left (lower real
                                returns)
                            </li>
                            <li>
                                Bond supply curve shifts right (borrowers expect
                                to repay in cheaper dollars)
                            </li>
                            <li>
                                Result: Bond prices fall and interest rates rise
                            </li>
                        </ul>
                        ...
                        <ul className="list-disc pl-5 space-y-1">
                            <li>
                                Bond demand curve shifts right (higher real
                                returns)
                            </li>
                            <li>
                                Bond supply curve shifts left (borrowers expect
                                to repay in more valuable dollars)
                            </li>
                            <li>
                                Result: Bond prices rise and interest rates fall
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                        ...
                        <p>
                            U.S. data from 1953-2020 shows a strong positive
                            correlation between expected inflation and interest
                            rates, supporting the Fisher effect theory.
                        </p>
                    </div>
                </div>
            </div>
    ...
    const renderBeerGame = () => (
        <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="mb-4">
                Experience the bullwhip effect in supply chains through this
    ...
    const renderTariffSimulator = () => (
        <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4">
                Tariff Policy Simulator
            </h2>
            <p className="mb-4">
                Explore how different tariff policies affect international trade
                outcomes.
            </p>
            <TariffSimulator />
        </div>
    ...
    const renderTariffGame = () => (
        <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4">
                Interactive Tariff Game
            </h2>
            <p className="mb-4">
                Play as a trade policy maker and see the consequences of your
                decisions.
            </p>
            <TariffGame />
        </div>
